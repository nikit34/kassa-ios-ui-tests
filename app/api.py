...
def _logging(this, method, url, content=''):
    path_log = os.path.abspath(os.path.join(os.path.dirname(__file__), "../kassa-ui-tests")) + '/app/api.log'
...
class DebugAPI:
    def __init__(self, request=True, response=True):
        ...
        self.path_log = os.path.abspath(os.path.join(os.path.dirname(__file__), "../kassa-ui-tests")) + '/app/api.log'
